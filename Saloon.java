...
/**
 * This class inherits everything from the Car class. Its constructor sets the number of doors to 5, the number of seats to 5 and 
 * the type to "Saloon".
...
public class Saloon extends Car {
	...
	private static final String TYPE= "Saloon";
	
	Saloon(String plate,String model, String colour, int milage,String accidentHistory,boolean transmission, int price, String arrivalDate, String sellingDate){
